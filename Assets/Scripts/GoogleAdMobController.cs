...
public class GoogleAdMobController : MonoBehaviour
{
    ...
    private readonly String MY_APP_ID = "ca-app-pub-3434336829324852~6201224802";
    private readonly String App_OPEN_AD_UNIT_ID_TEST = "ca-app-pub-3940256099942544/5662855259";
    private readonly String App_OPEN_AD_UNIT_ID = "ca-app-pub-3434336829324852/9606986889";

    private readonly String BANNER_AD_UNIT_ID_TEST = "ca-app-pub-3940256099942544/2934735716";
    private readonly String BANNER_AD_UNIT_ID = "ca-app-pub-3434336829324852/7537187314";

    private readonly String INTERSTITIAL_AD_UNIT_ID_TEST = "ca-app-pub-3940256099942544/4411468910";
    private readonly String INTERSTITIAL_AD_UNIT_ID = "ca-app-pub-3434336829324852/4771207573";

    private readonly String INTERSTITIAL_VIDEO_AD_UNIT_ID_TEST = "ca-app-pub-3940256099942544/5135589807";

    private readonly String REWARDED_AD_UNIT_ID_TEST = "ca-app-pub-3940256099942544/1712485313";
    private readonly String REWARDED_AD_UNIT_ID = "ca-app-pub-3434336829324852/4380325339";

    private readonly String REWARDED_INTERSTITIAL_AD_UNIT_ID_TEST = "ca-app-pub-3940256099942544/6978759866";
    private readonly String REWARDED_INTERSTITIAL_AD_UNIT_ID = "ca-app-pub-3434336829324852/1562590309";

    private readonly String NATIVE_ADVANCED_AD_UNIT_ID_TEST = "ca-app-pub-3940256099942544/3986624511";
    private readonly String NATIVE_ADVANCED_AD_UNIT_ID = "ca-app-pub-3434336829324852/4175530950";

    private readonly String NATIVE_ADVANCED_VIDEO_AD_UNIT_ID_TEST = "ca-app-pub-3940256099942544/2521693316";
...
#if UNITY_IPHONE
        //deviceIds.Add("89049032005008882600040877398682");
#elif UNITY_ANDROID
    ...
    public void RequestBannerAd()
    {
        ...
        string adUnitId = BANNER_AD_UNIT_ID_TEST;
#elif UNITY_ANDROID
                string adUnitId = "ca-app-pub-3940256099942544/6300978111";
#elif UNITY_IPHONE
                //string adUnitId = "ca-app-pub-3940256099942544/2934735716";
                string adUnitId = BANNER_AD_UNIT_ID;
#else
...
#if UNITY_EDITOR
        //string adUnitId = "unused";
        string adUnitId = INTERSTITIAL_AD_UNIT_ID_TEST;
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-3940256099942544/1033173712";
#elif UNITY_IPHONE
        //string adUnitId = "ca-app-pub-3940256099942544/4411468910";
        string adUnitId = INTERSTITIAL_AD_UNIT_ID;
#else
        string adUnitId = "unexpected_platform";
#endif
...
#if UNITY_EDITOR
        //string adUnitId = "unused";
        string adUnitId = REWARDED_AD_UNIT_ID_TEST;
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-3940256099942544/5224354917";
#elif UNITY_IPHONE
        //string adUnitId = "ca-app-pub-3940256099942544/1712485313";
        string adUnitId = REWARDED_AD_UNIT_ID;
#else
        string adUnitId = "unexpected_platform";
#endif
...
#if UNITY_EDITOR
        //string adUnitId = "unused";
        string adUnitId = REWARDED_INTERSTITIAL_AD_UNIT_ID_TEST;
#elif UNITY_ANDROID
            string adUnitId = "ca-app-pub-3940256099942544/5354046379";
#elif UNITY_IPHONE
            //string adUnitId = "ca-app-pub-3940256099942544/6978759866";
            string adUnitId = REWARDED_INTERSTITIAL_AD_UNIT_ID;
#else
            string adUnitId = "unexpected_platform";
#endif
